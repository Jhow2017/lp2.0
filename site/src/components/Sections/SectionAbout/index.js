...
const SectionAbout = () => {
    ...
    return(
        <>
        <section id="section-about" style={{background: 'url(https://firebasestorage.googleapis.com/v0/b/rstcom20.appspot.com/o/companies%2Fnovalp%2Flp%2Fbg%2F4.jpg?alt=media&token=9bb4614c-4d18-45a3-a977-849155de90fd) left top / cover'}}>
